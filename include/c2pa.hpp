...
namespace c2pa
{
    ...
    public:
        ...
        public:
            ...
            /// @param context Opaque user pointer passed to every callback invocation (may be nullptr).
            /// @param callback Function pointer matching C2paHttpResolverCallback.
            /// @return Reference to this ContextBuilder for method chaining.
            /// @throws C2paException if the resolver could not be set.
            ContextBuilder& with_http_resolver(void* context, C2paHttpResolverCallback callback);
